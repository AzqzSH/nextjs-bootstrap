...
const Footer: React.FC<FooterProps> = ({}) => {
	return (
		<footer className="bg-white w-full py-24 px-4 relative -mt-6    ">
			<div className="px-4 pt-3 pb-4 border-b -mx-4 border-gray-400">
				<div className="max-w-xl mx-auto">
					...
					<p className="text-gray-700 text-xs pl-px">
						Latest news ,articles and updates montly delevered to
						your inbox.
					</p>
			...
			<div className="flex items-center justify-between my-4">
				<div className="flex items-center">
					<a href="#">
						<svg
							className="h-6 w-6 fill-current text-red-400 mr-6"
							viewBox="0 0 512 512"
						>
					...
					<a href="#">
						<svg
							fill="none"
							className="h-6 w-6 text-red-400 mr-6"
							viewBox="0 0 24 24"
							stroke="currentColor"
						>
							<path
